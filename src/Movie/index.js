...
function Movie(props){
    ...
    return(
        <div className='movie'>
            ...
            <h3>Generos: </h3>
            <List>
                {props.movieList.genres.map(genero => (
                    <ListItem
                        key={genero.name}
                        name={genero.name}
                    />
            ...
            <p className='budget' id='budget'>Presupuesto: {props.movieList.budget}</p>
            <h3>Overview: </h3>
            <p className='overview' id='overview'>{props.movieList.overview}</p>
            <p className='rating' id='rating'>Rating: {props.movieList.popularity}</p>
            <h3>Production companies:</h3>
            <List>
                {props.movieList.production_companies.map(genero => (
                    <ListItem
                        key={genero.name}
                        name={genero.name}
                    />
            ...
            <p className='status' id='status'>Status: {props.movieList.status}</p>
